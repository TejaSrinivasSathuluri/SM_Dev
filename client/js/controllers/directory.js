angular
  ...
  .controller('DirectoryController',function ($scope,ngDialog, Admin, $state, School, Class, Student, Parent, StudentParent, Staff, $rootScope, $window,fileUpload,$filter,Timetable,Schedule,$http) {
